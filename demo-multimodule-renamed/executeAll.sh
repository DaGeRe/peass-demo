...
INITIALVERSION="1f17e262475fc5e7fa555a47758e65399c788b85"
...
STATE=$(grep -A21 '"call" : "de.AnotherTest#testMe",' results/$VERSION/module-using§de.AnotherTest_testMe.js \
    | grep '"state" : "SLOWER",' \
    | grep -o 'SLOWER')
if [ "$STATE" != "SLOWER" ]
then
