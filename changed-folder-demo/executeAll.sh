...
echo ":::::::::::::::::::::SELECT:::::::::::::::::::::::::::::::::::::::::::"
java -jar $PEASS_FILE select -folder $DEMO_HOME -notUseSourceInstrumentation -testClassFolder src/myTestName/java

INITIALVERSION="a4e04a268991230f0d29ba801e6703ab5c6ce5f6"
...
echo ":::::::::::::::::::::MEASURE::::::::::::::::::::::::::::::::::::::::::"
java -jar $PEASS_FILE measure -executionfile $EXECUTION_FILE -folder $DEMO_HOME -vms 5 -iterations 5 -warmup 5 -repetitions 5 -testClassFolder src/myTestName/java
...
java -jar $PEASS_FILE searchcause -vms 3 -iterations 5 -warmup 1 -repetitions 5 -commit $VERSION \
    ...
    -testClassFolder src/myTestName/java
