...
DEMO_PROJECT_NAME=project-scala
...
INITIALCOMMIT="0133f8a6ff22483d59415e3193a463eb5c076716"
...
java -jar $PEASS_FILE searchcause -vms 5 -iterations 5 -warmup 5 -repetitions 5 -commit $COMMIT \
    -test de.dagere.peass.ExampleTest\#test \
    -folder $DEMO_HOME \
    -executionFile $EXECUTION_FILE \
    -rcaStrategy $rcaStrategy \
    -propertyFolder $PROPERTY_FOLDER \
    -writingType BinarySimple
